...
import { faAward, faCalendarDays, faEnvelope, faLink, faMapLocationDot, faMoneyCheckDollar, faPhone, faStar, faTableCells, faUserTie } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="max-w-7xl mx-40 my-10  max1024:mx-5  ">
            ...
            <div className="flex my-8 p-4 pl-10 pr-5  justify-between items-center color-[#fff]  border-gray-300 shadow-lg">
                ...
                <Avatar>
                  ...
                  <Button className="my-2 mx-2  bg-gray-300 text-gray-500 cursor-pointer rounded px-2 py-2"><FontAwesomeIcon icon={faAward} />{singleUser?.profile?.skills}</Button>
